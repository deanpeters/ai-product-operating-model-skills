---
name: aipom-workflow-opportunity-advisor
description: Identify which product-team decision or productive workflow should be redesigned with AI first, based on outcome value, friction, evidence, consequence, and readiness.
type: interactive
...
group_size: 2-8
depends_on: []
combine_with: [aipom-productive-motion-map, human-aipom-work-contract, aipom-workflow-playbook-builder]
sources: []
---
