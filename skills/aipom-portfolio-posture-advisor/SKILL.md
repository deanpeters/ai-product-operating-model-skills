---
name: aipom-portfolio-posture-advisor
description: Diagnose AI portfolio imbalance, premature scaling, weak evidence, vendor exposure, and zombie pilots; recommend where to explore, validate, scale, pause, or stop.
type: interactive
...
assessment_questions: [POR-01, POR-02, POR-03, POR-04, POR-05, STR-04]
maturity_move: {from: emerging, to: repeatable}
estimated_time: 45-75 min
group_size: 2-8
depends_on: []
combine_with: [aipom-bet-charter, aipom-use-case-triage, aipom-operating-model-roadmap]
sources: []
---
