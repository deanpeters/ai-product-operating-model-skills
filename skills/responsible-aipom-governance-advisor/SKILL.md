...
1. Define scope, operating level, affected people, and decision.
2. Extract owners, AI actions, consequences, obligations, controls, and evidence.
3. Diagnose ownership, authority, control, escalation, review, and assurance gaps.
4. Separate legal requirements from recommended practice and flag jurisdiction.
5. Identify any critical gap that constrains launch, scale, data use, or autonomy.
6. Present intervention options and recommend the smallest effective motion.
7. Assign a human owner, evidence expected, and review trigger.
...
- [Governance diagnosis template](template.md)
- [Synthetic worked example](examples/worked-example.md)
- [Weak example](examples/weak-example.md)

## Sources

- NIST, [AI RMF 1.0](https://www.nist.gov/publications/artificial-intelligence-risk-management-framework-ai-rmf-10), January 26, 2023. Supports organizational governance and lifecycle risk management. Accessed July 16, 2026.
- OECD.AI, [Accountability Principle](https://oecd.ai/en/dashboards/ai-principles/P9). Supports role-based accountability, traceability, and ongoing risk management. Accessed July 16, 2026.
- European Union, [Regulation (EU) 2024/1689](https://eur-lex.europa.eu/eli/reg/2024/1689/oj). Supports risk-proportionate human oversight for covered high-risk systems. Accessed July 16, 2026. This advisor is not legal advice and does not establish compliance.
