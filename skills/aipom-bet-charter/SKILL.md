---
name: aipom-bet-charter
description: Turn an AI idea into an owned investment hypothesis with outcomes, economics, constraints, evidence, and a next learning test. Use before funding or expanding an initiative.
type: component
...
best_for:
  ...
  - Preparing a portfolio review or stage-gate decision
evidence_required:
  - Customer or workflow problem evidence
  - Expected outcomes and economic assumptions
  - Feasibility, data, evaluation, and governance constraints
  - Results from prior tests where available
produces:
  - One-page AI bet charter
  - Assumption and evidence ledger
  - Next test and decision rule
assessment_questions: [POR-01, POR-02, POR-03, STR-02, STR-04]
maturity_move: {from: emerging, to: repeatable}
estimated_time: 45-60 min
group_size: 3-8
depends_on: [aipom-strategy-thesis-advisor]
combine_with: [aipom-use-case-triage, aipom-investment-stage-gates, aipom-economic-case-builder]
sources: []
---
