---
name: aipom-strategy-thesis-advisor
description: Turn scattered AI ambition into an evidence-aware product strategy thesis with choices, boundaries, outcomes, assumptions, and next bets. Use when direction or non-goals are unclear.
type: interactive
...
best_for:
  - Converting broad AI ambition into strategic choices
  - Aligning leaders on where AI should and should not be used
  - Connecting proposed AI bets to customer and economic outcomes
  - Revising an AI strategy after evidence or market conditions change

evidence_required:
  - Current product and business strategy
  - Customer or end-user evidence
  - Portfolio and investment evidence
  - Relevant product, workflow, data, evaluation, and governance constraints
  - Results from existing AI experiments where available

produces:
  - AI product strategy thesis
  - Strategic choices and non-goals
  - Evidence and assumption ledger
  - Portfolio implications and next learning bets
...
2. Strategic context and outcome priorities
3. The strategy thesis
4. Chosen arenas and explicit non-goals
5. Causal beliefs and differentiating advantage
6. Evidence, assumptions, and confidence
7. Portfolio implications
8. Next learning bets and decision triggers
9. Named decision owner and review cadence
...
1. Which decision must this thesis guide?
2. Which customer or organizational outcome matters most, and what evidence supports it?
3. Where might AI create a meaningful advantage over current and non-AI alternatives?
4. What constraints and non-goals must shape the choice?
5. Which next bet would reduce the most important uncertainty?
...
1. **Customer-value focus:** prioritize differentiated customer outcomes.
2. **Productive-work focus:** improve consequential internal decisions or workflows.
3. **Trust-and-control focus:** establish the conditions required for responsible value creation.
4. **Learning-platform focus:** build reusable context, evaluation, or workflow capability through bounded bets.
...
- [Strategy thesis template](template.md)
